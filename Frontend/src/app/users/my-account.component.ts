...
@Component({
	...
	template: `
		...
		<input-component label="Website" [control]="websiteControl" [(model)]="user.website" (onBlur)="blurrySave($event, 'website')" ></input-component>
...
export class MyAccountComponent implements OnInit {
	...
	public blurrySave(value, key): void {
		...
		this.socketService.responseSocket(this.updatePath, {id: this.user.id, [key]: value}).subscribe(response => {
