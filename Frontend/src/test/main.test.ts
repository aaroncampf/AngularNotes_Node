...
describe(`QuoteListComponent ${i}`, () => {
	...
	afterEach('I am after each', () => {
		getTestBed().resetTestingModule();
	});

	it('It should receive a quote from QuotesService', () => {
		...
		console.log('34 test', typeof this.quoteID);
		expect(typeof this.quoteID).to.Be.a('number');
	});
