...
@Component({
	...
	template: `
		...
		<hr>
		<div [formGroup]="form">
			<input-component label="First Name" [control]="firstNameControl" [(model)]="user.firstName" (onBlur)="blurrySave($event, 'firstName', form)"></input-component>
			<input-component label="Last Name" [control]="lastNameControl" [(model)]="user.lastName" (onBlur)="blurrySave($event, 'lastName', form)"></input-component>
			<input-component label="Email" [control]="emailControl" [(model)]="user.email" (onBlur)="blurrySave($event, 'email', form)"></input-component>
			<input-component label="Phone" [control]="phoneControl" [(model)]="user.phone" (onBlur)="blurrySave($event, 'phone', form)"></input-component>
			<input-component label="Website" [control]="websiteControl" [(model)]="user.businessWeb" (onBlur)="blurrySave($event, 'businessWeb', form)"></input-component>
			<input-component label="Address One" [control]="addressOneControl" [(model)]="user.addressOne" (onBlur)="blurrySave($event, 'addressOne', form)"></input-component>
			<input-component label="Address Two" [control]="addressTwoControl" [(model)]="user.addressTwo" (onBlur)="blurrySave($event, 'addressTwo', form)"></input-component>
			<input-component label="Business Fax" [control]="businessFaxControl" [(model)]="user.businessFax" (onBlur)="blurrySave($event, 'businessFax', form)"></input-component>
			<input-component label="Business Name" [control]="businessNameControl" [(model)]="user.businessName" (onBlur)="blurrySave($event, 'businessName', form)"></input-component>
			<input-component label="Business Phone" [control]="businessPhoneControl" [(model)]="user.businessPhone" (onBlur)="blurrySave($event, 'businessPhone', form)"></input-component>
		</div>
	`
})
...
export class MyAccountComponent implements OnInit {
	...
	public blurrySave(value, key, form): void {
		this.socketService
